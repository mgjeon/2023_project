...
# ╔═╡ 796cefe7-9f69-4b6f-b26d-576c618ee751
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 8615d62c-667e-11ee-20c7-a1c89b28d11f
md"# Continuous Compound Interest"

# ╔═╡ d4855bbb-eed5-4137-9f6c-6941ae8e5e49
md"# Continuous Compound Interest"

# ╔═╡ 6381e741-c14e-4d8e-9660-640557698ab8
md"## Describe Problem"

# ╔═╡ 7291ab16-39e7-4846-8994-e31c3c371836
md"### Ordinary Differential Equation (ODE)"

# ╔═╡ a34299df-a1a5-4313-adc9-0380e9047baf
md"$\frac{du}{dt} = pu$"

# ╔═╡ 4499b1b5-b8dc-40a7-ba6f-428615579c2f
f(u, p, t) = p*u

# ╔═╡ 5dc0bb48-180e-4ed4-901c-6e72045e8102
t_begin = 0.0

# ╔═╡ 3a569025-e7fc-4a0e-aa14-3b02e81840d1
md"Interest Rate: $(@bind p Slider(0.01:0.01:1.0, 1.0, true))"

# ╔═╡ 5e715b17-edf1-4f9d-a9c0-d8da17bac0c1
md"Beginning Balance: $(@bind u_begin Slider(1.0:1000.0, 1.0, true))"

# ╔═╡ a5acde2e-e169-4f0d-be0c-19895f4d8fe3
md"Years: $(@bind t_end Slider(1.0:50.0, 1.0, true))"

# ╔═╡ 7b3d2f87-b8b1-4a75-ad7e-54dd440393cb
tspan = (t_begin, t_end)

# ╔═╡ 1d50f8a4-0e29-4365-843b-0e8554ff4aac
prob = ODEProblem(f, u_begin, tspan, p)

# ╔═╡ e20c2ad4-6642-4565-8b9c-12a9f5bf445e
sol = solve(prob)

# ╔═╡ e099ad18-6718-4774-b257-5d9f25e76d78
md"Ending Balance: $(round(Int, sol(t_end)))"

# ╔═╡ afe613fb-a506-4406-9e05-6c6214f01927
plot(sol,
	 legend=false,
	 linewidth = 2,
	 title = "Continous Compound Interest",
	 xaxis = "Time in Years",
	 yaxis = "Accound Balance in Dollars",
	 formatter = :plain,
	 widen = true,
	 xlims = (0.0, 50.0),
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "6a9d8545947575adfcee24ffc9b24989d3ac1321"
